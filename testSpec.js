...
describe('unit test',function(){
  ...
  describe('buildDigits',function(){
    ...
    it('split digit',function(){
      var digitArray = nodeLcd.buildDigits(910);
  ...
  describe('digitString', function() {
    ...
    beforeEach(function() {
      digits = 910;
      allDigitsString = nodeLcd.loadAllDigits();
    });
    ...
    it('show lcdDigitsString',function(){
      var lcdDigitText = nodeLcd.biuldLcdString([9,1,0],allDigitsString);
  ...
  describe('lcdDigits',function(){
    ...
    it('printLcdDigits',function(){
      var lcdDigits = nodeLcd.printLcdDigits([['._.','|_|','..|'],['...','..|','..|'],['._.','|.|','|_|']]);
      var expectText =
        '._.' + ' ' + '...' + ' ' + '._.' + '\n' +
        '|_|' + ' ' + '..|' + ' ' + '|.|' + '\n' +
        '..|' + ' ' + '..|' + ' ' + '|_|' + '\n';
